...
import ru.itmo.general.network.requests.GetPersonByIdRequest;
import ru.itmo.general.network.responses.GetPersonByIdResponse;
...
public class PersonForm extends Form<Person> {
     ...
     * @param tcpClient
     */
    public PersonForm(Console console, TCPClient tcpClient) {
    ...
    public Person build() throws InvalidScriptInputException, InvalidFormException {
        ...
        try {
            if (input.startsWith("id=") || input.startsWith("ID=")) {
                ...
                Response response = tcpClient.sendCommand(new GetPersonByIdRequest(input));
                var person = ((GetPersonByIdResponse) response).getPerson();
